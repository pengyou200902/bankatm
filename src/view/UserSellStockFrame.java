 ...
 * @author oshorawal
 */
public class UserSellStockFrame extends javax.swing.JDialog {

    /**
     * Creates new form user_sell_stock_frame
     */
    private Security user_bank_account;
    private StockController stock_controller;
    public UserSellStockFrame(java.awt.Frame parent, boolean modal, Security acc) {
        super(parent, modal);
    ...
    private void submit_buttonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_submit_buttonActionPerformed
        ...
        res = this.stock_controller.sellStock(this.user_bank_account,name,quantity);
        if(res.status){
            javax.swing.JOptionPane.showMessageDialog(this,"Stocks Sold","Message",javax.swing.JOptionPane.PLAIN_MESSAGE);  
         }
        else{
...
//            java.util.logging.Logger.getLogger(user_sell_stock_frame.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
...
//            public void run() {
//                user_sell_stock_frame dialog = new user_sell_stock_frame(new javax.swing.JFrame(), true);
